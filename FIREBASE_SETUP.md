# 🔥 Firebase Setup Guide — Make Free Invoice Auth
...
2. Click **"Add project"**
3. Name it `Make Free Invoice` → Continue
...
2. App nickname: `Make Free Invoice Web` → **Register app**
...
2. Your Firebase domain is already there. Add:
   ...
   - Your production domain e.g. `www.make-free-invoice.com`
