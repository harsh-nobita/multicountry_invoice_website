# ⬡ Make Free Invoice — Free Professional Invoice Generator
...
### Custom Domain
Update `sitemap.xml` and replace `https://www.make-free-invoice.com/` with your actual domain.
...
- [ ] Update brand name (`Make Free Invoice`) across all HTML files if rebranding
